...
eempleado::eempleado(int id, QSqlRelationalTableModel *modelo, const QString &titulo, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::eempleado)
{
    ui->setupUi(this);
...
void eempleado::changeEvent(QEvent *e)
{
...
void eempleado::Aceptar()
{
        ...
        ui->g->text().isEmpty() )
    {
        ...
        if (accepted == 1) {
            ...
            QSqlField f7("Cargo", QVariant::String);
            ...
            f7.setValue(QVariant(ui->g->text()));
